...
class ProductosADM extends React.Component {
  ...
  handleRemove(product, e) {
    let opc = window.confirm("¿Está seguro de que desea eliminar el producto "+product.reference+"?");
    if(opc){
      ProductService.remove(product.reference).then((response)=>{
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-2">
              <ModalProduct title="Crear Producto" getProducts={this.getProducts}></ModalProduct>
            </div>
          </div>
          <div className="row">
              ...
              <tbody>
                {this.state.products.map((product, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <img src={product.photography} alt={product.reference} width={100} height={55}/>
                    </td>
                    <td>
                      <ModalProduct
...
class ModalProduct extends React.Component {
  ...
  handleSubmit(e, type, product) {
    if (type === "Crear Producto") {
      ...
      ProductService.update(product).then((response)=>{
            ...
            >
              <div className="col-md-6">
                ...
                <input
                  ...
                  disabled={this.props.title==="Crear Producto"?false:true}
                />
              </div>
              <div className="col-md-6">
